CategoryColor = Color(93, 48, 148, 255)
JobColor = Color(18, 6, 64, 255)
...
HRP.AddF4MenuTab("Jobs", function (panel)
	...
	for i = 1, #HRP.jobsTable do
		...
		cat.Paint = function()
			...
			draw.RoundedBox(0, 0, 0, cat:GetWide(), cat:GetTall(), CategoryColor)
		...
		for j = 1, #HRP.jobsTable[i].jobTitles do
			...
			job.Paint = function()
				...
				draw.RoundedBox(0, 2, 2, job:GetWide()-4, job:GetTall()-4, JobColor)
