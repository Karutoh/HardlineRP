hook.Add("TRP_SavePlayerData", "TRP_CacheSkills", function (f, ply)
...
hook.Add("TRP_LoadPlayerData", "TRP_CacheSkills", function (f, ply)
...
hook.Add("TRP_InitPlayerData", "TRP_InitSkills", function (ply)
